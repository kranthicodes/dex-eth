...
contract Dex{
    ...
    function createLimitOrder(bytes32 ticker, uint amount, uint price, Side side) external tokenIsNotDai(ticker) tokenExist(ticker) {
        if(side == Side.SELL){
        ...
        //bubble sort to do sizetime sorting
